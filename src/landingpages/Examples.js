        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-md-10 col-lg-9 col-xl-8">
              ...
              <div dangerouslySetInnerHTML={{__html: `<iframe src='https://justcast.com/widget/inside-the-aluminum-tube-with-shanon-baker/episodes/1077405' width='100%' height='370px' frameborder='0' scrolling='yes' seamless='true' style="height:370px; width:100%;"></iframe>`}}/>              
            </div>
          </div>
        </div>
      </section>
