...
export const addPodcastAtom = atom(null, (_get, set, input) => {
  set(podcastAtom, () => {
    const {name, id, artwork_url_256, hide_widget_pub_date, current_episode_idx, total_episodes} = input
    return {name, id, artwork_url: artwork_url_256, hide_widget_pub_date, current_episode_idx, total_episodes};
  });
})
