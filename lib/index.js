...
SEOHelpers.set = (meta, data) => {
  ...
  meta.img_16 ? data = data.replace(/\$IMG_16/g, meta.img_16) : null;
  ...
  meta.img_16 ? data = data.replace(/\$OG_FAVICON/g, meta.img_16) : data.replace(/\$OG_FAVICON/g, "%PUBLIC_URL%/favicon.ico");
